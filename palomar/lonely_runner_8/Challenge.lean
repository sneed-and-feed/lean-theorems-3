...
theorem canonicalSpeeds8_lonely_at_one_ninth (i : Fin 8) :
    IsLonely (canonicalSpeeds8 i) (1 / 9 : ℝ) (1 / 9 : ℝ) := sorry
...
theorem canonicalSpeeds8_fails_counterexample_condition :
    ¬ (∀ t : ℝ, t > 0 → ¬ (∀ i : Fin 8, IsLonely (canonicalSpeeds8 i) t (1 / 9 : ℝ))) := sorry
...
theorem canonicalSpeeds8_cannot_be_counterexample
    (cert : CounterexampleCertificate8) (h : cert.speeds = canonicalSpeeds8) : False := sorry
