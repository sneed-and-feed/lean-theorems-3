...
theorem Q_N_S6_w_pos :
    Q_N_S6 w w = 6 := by
  dsimp [Q_N_S6, symplecticPairingOmega6, ModularFamilyS6.N, mulVec, dotProduct, Fin.sum_univ_four, w, ModularFamilyS6.w]
  decide
...
theorem Q_N_S6_delta_eval :
    Q_N_S6 delta delta = -1 := by
  dsimp [Q_N_S6, symplecticPairingOmega6, ModularFamilyS6.N, mulVec, dotProduct, Fin.sum_univ_four, delta, ModularFamilyS6.delta]
  decide
